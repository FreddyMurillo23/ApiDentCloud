<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'GET') {
		if(isset($_GET['room_id'])){
			$room->room_id = isset($_GET['room_id']) ? $_GET['room_id'] : '';
			$stmt = $room->findOne();
		...
		$room->room_id = isset($jsondata['room_id']) ? utf8_decode($jsondata['room_id']) : '';
		$room->room_type_id = isset($jsondata['room_type_id']) ? utf8_decode($jsondata['room_type_id']) : '';
		$room->room_date = isset($jsondata['room_date']) ? utf8_decode($jsondata['room_date']) : '';
